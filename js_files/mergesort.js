...
async function merge(ele, low, mid, high){
    ...
    for(let i = 0; i < n1; i++){
        ...
        // color
        ele[low + i].style.background = 'DarkViolet';
    ...
    for(let i = 0; i < n2; i++){
        ...
        // color
        ele[mid + 1 + i].style.background = 'DeepPink';
...
const mergeSortbtn = document.getElementById("mergesort").addEventListener('click', async function(){
    ...
    h1.id = "curr";
    h1.innerText = "Currently Running - MergeSort";
